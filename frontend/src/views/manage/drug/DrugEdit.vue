<template>
  <a-modal v-model="show" title="修改药材" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="6">
          <a-form-item label='药材名称' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
        ...
        <a-col :span="6">
          <a-form-item label='药材类别' v-bind="formItemLayout">
            <a-select v-decorator="[
              'classification',
        ...
        <a-col :span="6">
          <a-form-item label='药材性' v-bind="formItemLayout">
            <a-select v-decorator="[
              'nature',
              { rules: [{ required: true, message: '请输入药材性!' }] }
              ]">
        ...
        <a-col :span="6">
          <a-form-item label='药材味' v-bind="formItemLayout">
            <a-select v-decorator="[
              ...
              <a-select-option value="酸甘">酸甘</a-select-option>
        ...
        <a-col :span="24">
          <a-form-item label='药材图片' v-bind="formItemLayout">
            <a-upload
              name="avatar"
